  ...
  create (context) {
    ...
    return {
      [SUPER_CALL_SELECTOR] (superCallStatement) {
         ...
         * @returns {import('./shared/types').Position} - next token start position.
         */
        ...
        /**
         * Get fixing indent.
         * @param {import('./shared/types').Position} nextTokenStartPosition - Next token start position.
         ...
         * @returns {import('./shared/types').Token} - Comment token.
         */
