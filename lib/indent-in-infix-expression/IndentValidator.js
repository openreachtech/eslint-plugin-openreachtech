...
class IndentValidator {
   ...
   * @private
   * @returns {import('../shared/types').ASTNode|import('eslint').AST.Token} - Error target node or token.
   */
   ...
   * @param {import('../shared/types').ASTNode|import('eslint').AST.Token} targetToken - Target token to remove intent.
