...
class IndentValidator {
   ...
   * @private
   * @returns {import('../shared/types').ASTNode|import('../shared/types').Token} - Error target node or token.
   */
   ...
   * @param {import('../shared/types').ASTNode|import('../shared/types').Token} targetToken - Target token to remove intent.
